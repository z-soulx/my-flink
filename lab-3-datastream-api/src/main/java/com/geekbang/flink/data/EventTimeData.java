package com.geekbang.flink.data;
...
public class EventTimeData {
    ...
    public static List<Tuple3<Long, String, Long>> watermark = Arrays.asList(
        new Tuple3<>(1448892363000L, "Miko", 1L),
        new Tuple3<>(1448892364000L, "Miko", 1L),
        new Tuple3<>(1448892365000L, "Miko", 1L),
        new Tuple3<>(1448892366000L, "Miko1", 1L),
        new Tuple3<>(1448892367000L, "Miko1", 1L),
        new Tuple3<>(1448892364000L, "Miko", 1L),
        new Tuple3<>(1448892363000L, "Miko", 1L),
        new Tuple3<>(1448892362000L, "Miko", 1L)
    );
