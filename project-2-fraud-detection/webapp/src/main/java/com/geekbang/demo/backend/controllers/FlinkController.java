...
public class FlinkController {
  ...
  void syncRules() throws JsonProcessingException {
    Rule command = createControllCommand(RulePayload.ControlType.EXPORT_RULES_CURRENT);
    flinkRulesService.addRule(command);
  }

  @GetMapping("/clearState")
  void clearState() throws JsonProcessingException {
    Rule command = createControllCommand(RulePayload.ControlType.CLEAR_STATE_ALL);
    flinkRulesService.addRule(command);
  }
